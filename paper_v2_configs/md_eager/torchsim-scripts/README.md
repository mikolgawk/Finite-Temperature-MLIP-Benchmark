...
```text
paper_v2_configs/data/ref-trajs/md_metadata.json
```
...
| Script | Checkpoint |
| --- | --- |
| `md_eq_v2_M_omat.py` | `paper_v2_configs/data/models/eqV2_86M_omat_mp_salex.pt` |
| `md_esen_30M_OAM.py` | `paper_v2_configs/data/models/esen_30m_oam.pt` |

Other scripts use their model libraries' loaders and caches. GRACE OAM also
prepares a local artifact at
`paper_v2_configs/data/models/GRACE-2L-OMAT-large-ft-AM-fp32` if absent. Its eager
