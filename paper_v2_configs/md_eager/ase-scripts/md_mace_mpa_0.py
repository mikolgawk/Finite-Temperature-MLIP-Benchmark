...
# dependencies = ["ase>=3.26", "h5py>=3.11", "mace-torch==0.3.16", "numpy>=1.26", "torch", "tqdm>=4.66"]
# [[tool.uv.index]]
# name = "pytorch-cu128"
...
# ///
"""Native ASE energy/force-only counterpart to torchsim-scripts/md_mace_mpa_0.py.

Run: uv run ase-scripts/md_mace_mpa_0.py
"""
...
def make_calculator():
    ...
    return disable_mace_stress(MACECalculator(
