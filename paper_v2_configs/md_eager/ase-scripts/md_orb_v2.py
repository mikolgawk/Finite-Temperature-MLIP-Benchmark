...
# dependencies = ["ase>=3.26", "h5py>=3.11", "numpy>=1.26", "orb-models==0.6.2", "torch", "tqdm>=4.66"]
# [[tool.uv.index]]
# name = "pytorch-cu128"
...
# ///
"""Native ASE energy/force-only counterpart to torchsim-scripts/md_orb_v2.py.

Run: uv run ase-scripts/md_orb_v2.py
"""
