...
"""Stress-enabled md_eq_v2_M_omat.py: record potential stress for every saved trajectory frame."""
...
def make_calculator():
    ...
    retain_legacy_stress(calculator, "eqv2")
    return calculator


if __name__ == "__main__":
    run_ase_pressure("eq-v2-M-omat", make_calculator, "ase+fairchem-core-1.10.0")
