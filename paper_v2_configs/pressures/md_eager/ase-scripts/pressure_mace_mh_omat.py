...
"""Stress-enabled md_mace_mh_omat.py: record potential stress for every saved trajectory frame."""
...
def make_calculator():
    ...
    return retain_mace_stress(mace_mp(
        model="mh-1", default_dtype="float32", device="cuda", head="omat_pbe"
    ))


if __name__ == "__main__":
    run_ase_pressure("mace-mh-omat", make_calculator, "ase+mace-torch-0.3.16")
