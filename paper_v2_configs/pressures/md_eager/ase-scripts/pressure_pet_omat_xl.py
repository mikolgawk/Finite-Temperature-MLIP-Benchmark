...
# dependencies = ["ase>=3.26", "h5py>=3.11", "numpy>=1.26", "torch", "upet==0.2.6", "pandas>=2.2", "tqdm>=4.66"]
# [[tool.uv.index]]
# name = "pytorch-cu128"
...
"""Stress-enabled md_pet_omat_xl.py: record potential stress for every saved trajectory frame."""
...
if __name__ == "__main__":
    run_ase_pressure("pet-omat-xl", make_calculator, "ase+upet-0.2.6-eager-stress")
