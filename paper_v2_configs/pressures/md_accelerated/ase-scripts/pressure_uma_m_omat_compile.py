...
# dependencies = ["ase>=3.26", "h5py>=3.11", "numpy>=1.26", "fairchem-core==2.22.0", "torch==2.11.0+cu128", "pandas>=2.2", "tqdm>=4.66"]
# [[tool.uv.index]]
# name = "pytorch-cu128"
...
"""Stress-enabled md_uma_m_omat_compile.py: record potential stress for every saved trajectory frame."""
...
if __name__ == "__main__":
    run_ase_pressure("uma-m-omat-compile-stress", make_calculator,
