...
# dependencies = ["ase>=3.26", "h5py>=3.11", "numpy>=1.26", "mace-torch==0.3.16", "torch==2.11.0+cu128", "cuequivariance-torch>=0.4", "cuequivariance-ops-torch-cu12", "pandas>=2.2"]
# [[tool.uv.index]]
# name = "pytorch-cu128"
...
def make_calculator():
    ...
    return retain_mace_stress(mace_mp(model="mh-1", head="omat_pbe", **settings))


if __name__ == "__main__":
    run_ase_pressure("mace-mh-omat-compile", make_calculator,
