...
"""Stress-enabled md_uma_s_omat.py: record potential stress for every saved trajectory frame."""
...
if __name__ == "__main__":
    run_ase_pressure("uma-s-omat", make_calculator, "ase+fairchem-core-2.21.0")
