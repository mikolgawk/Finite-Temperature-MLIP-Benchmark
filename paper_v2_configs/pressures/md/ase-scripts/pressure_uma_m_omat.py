...
"""Stress-enabled md_uma_m_omat.py: record potential stress for every saved trajectory frame."""
...
def make_calculator():
    ...
    return retain_uma_stress(FAIRChemCalculator(predictor, task_name="omat"))


if __name__ == "__main__":
    run_ase_pressure("uma-m-omat", make_calculator, "ase+fairchem-core-2.21.0")
