"""Stress-enabled _ase_md.py: record potential stress for every saved trajectory frame."""
...
OUT_ROOT = REPO / "updated_configs" / "data" / "mlip-trajs-ase-accelerated-stress"
