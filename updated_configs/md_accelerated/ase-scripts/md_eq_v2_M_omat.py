...
# ///
"""Compiled native ASE energy/force-only counterpart to torchsim-scripts/md_eq_v2_M_omat_force_only_compile.py.

Run: uv run ase-scripts/md_eq_v2_M_omat_force_only_compile.py
"""
...
if __name__ == "__main__":
    run_ase_md("eq-v2-M-omat", make_calculator, "ase+fairchem-core-1.10.0+compile+force-only")
