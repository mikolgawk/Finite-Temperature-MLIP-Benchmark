...
# ///
"""Native ASE energy/force-only counterpart to torchsim-scripts/md_grace_oam_force_only_compile.py.

Run: uv run ase-scripts/md_grace_oam_force_only_compile.py
"""
...
if __name__ == "__main__":
    run_ase_md("grace-oam", make_calculator, "ase+tensorpotential-xla-force-only")
