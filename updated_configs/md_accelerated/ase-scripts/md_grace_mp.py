...
# ///
"""Native ASE energy/force-only counterpart to torchsim-scripts/md_grace_mp_force_only_compile.py.

Run: uv run ase-scripts/md_grace_mp_force_only_compile.py
"""
...
if __name__ == "__main__":
    run_ase_md("grace-mp", make_calculator, "ase+tensorpotential-xla-force-only")
