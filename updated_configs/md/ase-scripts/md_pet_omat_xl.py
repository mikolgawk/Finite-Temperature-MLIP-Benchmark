...
# ///
"""Native ASE energy/force-only counterpart to torchsim-scripts/md_pet_omat_xl.py.

Run: uv run ase-scripts/md_pet_omat_xl.py
"""
...
if __name__ == "__main__":
    run_ase_md("pet-omat-xl", make_calculator, "ase+upet-0.2.6-eager-force-only")
