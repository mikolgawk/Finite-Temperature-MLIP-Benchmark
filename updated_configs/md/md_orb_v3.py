...
# ///
"""TorchSim NVT production MD — orb-v3.
...
with positions and velocities:
    ...
    <OUT_ROOT>/<system>/nvt_orb-v3.h5

Run:  uv run md_orb_v3.py
"""
...
# model
# conservative-inference variant, MPA checkpoint, same as the ASE benchmark
