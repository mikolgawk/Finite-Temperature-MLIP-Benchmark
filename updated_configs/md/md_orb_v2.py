...
# model
# float32-highest == strict fp32 matmuls, no TF32, consistent with the header settings
orb_ff, atoms_adapter = pretrained.orb_v2(device=device, precision="float32-highest")
